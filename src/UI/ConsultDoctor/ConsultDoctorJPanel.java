...
public class ConsultDoctorJPanel extends javax.swing.JPanel {
    ...
    ConsultingDoctorRequest request;

    public ConsultDoctorJPanel(UserAccount account, Hospital hospital) {
        initComponents();
    ...
    private void initComponents() {
        ...
        tblCustomerStatus.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btnViewSymptoms.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnSuggestTest.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void populateTable() {
        ...
        ArrayList<WorkRequest> workRequest = hospital.getWorkQueue().getWorkRequestListArray3();
        for (int i = workRequest.size() - 1; i >= 0; i--) {
            ConsultingDoctorRequest req = (ConsultingDoctorRequest) workRequest.get(i);
...
//            }
    ...
    private void btnSuggestTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuggestTestActionPerformed
        ...
        if (selectedRow < 0) {
            Toast message = new Toast(mainPanel, "Please select a row to suggest test", false);
            return;
        }
        
        request = (ConsultingDoctorRequest) tblCustomerStatus.getValueAt(selectedRow, 0);
        if (request.getStatus().equals("Done")) {
            Toast message = new Toast(mainPanel, "Test already suggested", false);
            return;
        }
    ...
    private void btnViewSymptomsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewSymptomsActionPerformed
        ...
        if (selectedRowIndex < 0) {
            Toast message = new Toast(mainPanel, "Please select a row to view symptoms", false);
            return;
        }

        DefaultTableModel model = (DefaultTableModel) tblCustomerStatus.getModel();
        ConsultingDoctorRequest request = (ConsultingDoctorRequest) model.getValueAt(selectedRowIndex, 0);

        populateSymptomsTable(request.getSymptomsArray());
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (isValidData()) {
            ...
            request.setMsg(txtRemarks.getText());
            ...
            Toast message = new Toast(mainPanel, "Test suggested successfully", true);
        }
