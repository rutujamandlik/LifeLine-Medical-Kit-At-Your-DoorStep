 ...
 * @author milindsharma
 */
public class LabTechnicianManageTestResultsJPanel extends javax.swing.JPanel {
     ...
     */
    public LabTechnicianManageTestResultsJPanel(UserAccount account, Hospital hospital) {
        initComponents();
        ...
        panelSendToDoctor.setVisible(false);
    ...
    private void initComponents() {
        ...
        btnSendResults.setForeground(new java.awt.Color(0, 0, 0));
        btnSendResults.setText("Send Results to Doctor");
        ...
        jLabel2.setText("Send to Doctor");
        ...
        doctorPicker.setBackground(new java.awt.Color(79, 173, 177));
        doctorPicker.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
            ...
            .addGroup(panelSendToDoctorLayout.createSequentialGroup()
                ...
                .addGroup(panelSendToDoctorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(panelSendToDoctorLayout.createSequentialGroup()
                        ...
                        .addComponent(doctorPicker, 0, 325, Short.MAX_VALUE))
        ...
        panelSendToDoctorLayout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelSendToDoctorLayout.createSequentialGroup()
                ...
                .addGroup(panelSendToDoctorLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(doctorPicker, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        btnPerformTest.setForeground(new java.awt.Color(0, 0, 0));
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(panelSendToDoctor, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void btnSendResultsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendResultsActionPerformed
        ...
        if (selectedRow < 0){
            Toast toast = new Toast(mainPanel, "Please select a row to send results", false);
            return;
        }

        request = (TestRequest) tblRequests.getValueAt(selectedRow, 0);
        if(request.getStatus().equals("Test finished")){
            
            UserAccount ua = (UserAccount)doctorPicker.getSelectedItem();
            request.setReceiver(ua);
            request.setStatus("Sent to Doctor");
            populateTable();
            
            Toast toast = new Toast(mainPanel, "Test sent to doctor successfully", true);
        }
        else{
    ...
    private void btnSendActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSendActionPerformed
        ...
        request = (TestRequest) tblRequests.getValueAt(selectedRow, 0);
        panelSendToDoctor.setVisible(true);
        panelTestResult.setVisible(false);
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (isValidData()) {
            ...
            Toast toast = new Toast(mainPanel, "Test result submitted successfully", true);
            populateTable();
        }
    ...
    private void btnPerformTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPerformTestActionPerformed
        ...
        if (selectedRow < 0){
            Toast toast = new Toast(mainPanel, "Please select a row to perform test", false);
            return;
        }
...
//                Toast toast = new Toast(mainPanel, "This test has been processed before", false);
                return;
            }
...
//        layout.next(userProcessContainer);
    ...
    private javax.swing.JComboBox doctorPicker;
