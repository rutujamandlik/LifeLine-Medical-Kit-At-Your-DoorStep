...
public class ManageHomeDeliveryJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        tblHomeDelivery.setBackground(new java.awt.Color(255, 255, 255));
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        Toast toast = new Toast(mainPanel, "Home delivery partner deleted successfully", true);
...
//        }
      ...
      private void saveData() {
       Distribution distribution = (Distribution) distributionNamePicker.getSelectedItem();
        ...
        UserAccount ua = distribution.getUserAccountDirectory().createUserAccount(username, password, employee, new CustomerDeliveryPartnerRole());
        ...
        Toast toast = new Toast(mainPanel, "Home delivery partner added successfully", true);
    }
