 ...
 * @author milindsharma
 */
public class WarehouseAdminCreateProductJPanel extends javax.swing.JPanel {

    private UserAccount userAccount;
    private Warehouse warehouse;

    /**
     * Creates new form WarehouseAdminCreateOrderJPanel
     */
    public WarehouseAdminCreateProductJPanel(UserAccount userAccount, Warehouse warehouse) { 
        this.userAccount = userAccount;
        this.warehouse = warehouse;
        initComponents();
        
        lblProductNameValidation.setVisible(false);
        lblPriceValidation.setVisible(false);
        lblQuantityValidation.setVisible(false);
        populateTable();
        
        System.out.println(warehouse.getWorkQueue().getWorkRequestListArray());
        System.out.println(warehouse.getWorkQueue().getWorkRequestListArray2());
        System.out.println(warehouse.getWorkQueue().getWorkRequestListArray3());
    }
    ...
    private void populateTable(){
        ...
        for(Product product: warehouse.getProductDirectory().getProducts()){
    ...
    private void initComponents() {
        ...
        lblProductNameValidation = new javax.swing.JLabel();
        ...
        jLabel2.setText("Add Product Details");
        ...
        lblAdminName.setText("Product Name:");

        txtProductName.setFont(new java.awt.Font("Helvetica", 0, 14)); // NOI18N
        ...
        lblProductNameValidation.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        lblProductNameValidation.setForeground(new java.awt.Color(255, 0, 51));
        lblProductNameValidation.setText("jLabel2");
        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                ...
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGap(132, 132, 132)
                        .addComponent(lblProductNameValidation)
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel6Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txtProductName, javax.swing.GroupLayout.PREFERRED_SIZE, 365, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(0, 0, Short.MAX_VALUE))
        ...
        jPanel6Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {txtPrice, txtProductName, txtQuantity});
        ...
        jPanel6Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel6Layout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(lblProductNameValidation, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if (isValidData()) {
            ...
            Product product = warehouse.getProductDirectory().newProduct(name, price, quantity);
            ...
            warehouse.getWorkQueue().getWorkRequestListArray3().add(request);
            ...
            Toast toast = new Toast(mainPanel, "Product added successfully", true);
        }
    ...
    private boolean isValidData() {
        ...
        boolean isValidName = txtProductName.getText().matches("^[a-zA-Z]+$");

        if (txtProductName.getText().isEmpty()) {
            isValid = false;
            hideShowValidation(lblProductNameValidation, "Please enter product name");
...
//        }
    ...
    private javax.swing.JLabel lblProductNameValidation;
