...
public class ApproveDoctorJPanel extends javax.swing.JPanel {
    ...
    public ApproveDoctorJPanel(UserAccount account, Hospital hospital) { 
        initComponents();
    ...
    private void initComponents() {
        ...
        tblTestResult.setBackground(new java.awt.Color(255, 255, 255));
        ...
        btnApproveTest.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnSubmit2.setForeground(new java.awt.Color(0, 0, 0));
    ...
    private void populateTable(){
        ...
        ArrayList<WorkRequest> workRequest = hospital.getWorkQueue().getWorkRequestListArray2();
        
        for(int i=workRequest.size()-1; i>=0;i--){
            TestRequest req = (TestRequest)workRequest.get(i);
    ...
    private void btnApproveTestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnApproveTestActionPerformed
        ...
        if (selectedRow < 0) {
            Toast message = new Toast(mainPanel, "Please select a row to approve the test", false);
            return;
        }
        
        TestRequest request = (TestRequest)tblTestResult.getValueAt(selectedRow, 0);
    ...
    private void btnSubmit2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmit2ActionPerformed
            ...
            Toast message = new Toast(mainPanel, "Test approved successfully", true);
