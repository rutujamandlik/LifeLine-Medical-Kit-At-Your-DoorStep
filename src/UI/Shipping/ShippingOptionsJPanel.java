 ...
 * @author rutuja
 */
public class ShippingOptionsJPanel extends javax.swing.JPanel {
     ...
     */
    public ShippingOptionsJPanel(EcoSystem system, UserAccount userAccount, Warehouse warehouse) {
        initComponents();
        this.system = system;
    ...
    private void btnShippingOrdersActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnShippingOrdersActionPerformed
        ...
        ManageShippingPartnerJPanel manageShippingManJPanel = new ManageShippingPartnerJPanel(userAccount, warehouse);
