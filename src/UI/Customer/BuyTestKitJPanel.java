 ...
 * @author milindsharma
 */
public class BuyTestKitJPanel extends javax.swing.JPanel {
     ...
     */
    public BuyTestKitJPanel(UserAccount userAccount, EcoSystem system, Customer customer) {
        this.system = system;
    ...
    private void btnPlaceOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPlaceOrderActionPerformed
            ...
            if (noOfRows == 0) {
                Toast toast = new Toast(mainPanel, "Your cart is empty. Please add items first", false);
            } else {
                for(int i=0;i<noOfRows;i++){
                    ...
                    distribution.getWorkQueue().getWorkRequestListArray().add(request);
                    userAccount.getWorkQueue().getWorkRequestListArray().add(request);


                }
                Toast toast = new Toast(mainPanel, "Your order is successfully placed", true);
                populateTable();
            }
