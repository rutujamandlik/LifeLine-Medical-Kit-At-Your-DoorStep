 ...
 * @author milindsharma
 */
public class FDAAdminOptionJPanel extends javax.swing.JPanel {
    ...
    private FDA fda;    
    /**
     * Creates new form FDAAdminOptionsJPanel
     */
    public FDAAdminOptionJPanel(EcoSystem system, Enterprise enterprise, UserAccount account) {
        this.system = system;
    ...
    private void initComponents() {
        ...
        btnManageProductReq.setText("Manage Product Requests");
    ...
    private void btnManageProductReqActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageProductReqActionPerformed
        ...
        FDAManageProductJPanel fdaManageProductsJPanel = new FDAManageProductJPanel(account, warehouseEnterpriseArray, fda);
        ActivityJPanel.add("FDAManageProductJPanel", fdaManageProductsJPanel);
