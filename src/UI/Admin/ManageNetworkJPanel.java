...
public class ManageNetworkJPanel extends javax.swing.JPanel {
    ...
    public ManageNetworkJPanel(EcoSystem system) {
        this.system = system;
        initComponents();
        lblNetworkNameValidation.setVisible(false);
    ...
    private void initComponents() {
        ...
        lblNetworkNameValidation = new javax.swing.JLabel();
        ...
        lblName1.setText("Enter Network Name:");

        txtNetworkName.setFont(new java.awt.Font("Helvetica", 0, 14)); // NOI18N
        txtNetworkName.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                txtNetworkNameFocusGained(evt);
            }
        });
        ...
        txtNetworkName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtNetworkNameKeyTyped(evt);
            }
        });

        lblNetworkNameValidation.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        lblNetworkNameValidation.setForeground(new java.awt.Color(255, 0, 51));
        lblNetworkNameValidation.setText("jLabel2");
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(lblNetworkNameValidation)
                                .addGap(0, 0, Short.MAX_VALUE))
                            .addComponent(txtNetworkName, javax.swing.GroupLayout.DEFAULT_SIZE, 340, Short.MAX_VALUE))))
                .addContainerGap())
        );
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtNetworkName, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblName1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(2, 2, 2)
                .addComponent(lblNetworkNameValidation, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(22, 22, 22)
        ...
        tblNetworks.setBackground(new java.awt.Color(255, 255, 255));
        ...
        tblNetworks.setRowSelectionAllowed(false);
        tblNetworks.getTableHeader().setResizingAllowed(false);
        tblNetworks.getTableHeader().setReorderingAllowed(false);
    ...
    private void saveData() {
        ...
        Toast message = new Toast(mainPanel, "Network added successfully", true);
    }
    ...
    private boolean isValidData() {
        ...
        if (txtNetworkName.getText().isEmpty()) {
            isValid = false;
            hideShowValidation(lblNetworkNameValidation, "Please enter network name");
    ...
    private void txtNetworkNameFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtNetworkNameFocusGained
        // TODO add your handling code here:
        lblNetworkNameValidation.setVisible(false);
    }//GEN-LAST:event_txtNetworkNameFocusGained
    ...
    private void txtNetworkNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtNetworkNameKeyTyped
        // TODO add your handling code here:
        
    }//GEN-LAST:event_txtNetworkNameKeyTyped
    ...
    private javax.swing.JLabel lblNetworkNameValidation;
