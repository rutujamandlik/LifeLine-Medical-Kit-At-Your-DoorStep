 ...
 * @author milindsharma
 */
public class AdminManageOptionsJPanel extends javax.swing.JPanel {

    public static EcoSystem system;

    /**
     * Creates new form AdminManageOptionsJPanel
     */
    public AdminManageOptionsJPanel(EcoSystem business) {
    ...
    private void initComponents() {
        ...
        btnManageEnterprise.setBackground(new java.awt.Color(79, 173, 177));
        ...
        btnManageEnterpriseAdmins.setBackground(new java.awt.Color(79, 173, 177));
    ...
    private void btnManageEnterpriseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageEnterpriseActionPerformed
        ...
        if (system.getNetworkList().size() == 0) {
            JOptionPane.showMessageDialog(this, "Please create atleast one network first", "Error", JOptionPane.ERROR_MESSAGE);
        } else {
    ...
    private void btnManageEnterpriseAdminsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageEnterpriseAdminsActionPerformed
        ...
        for (Network network : system.getNetworkList()) {
            ...
            if (network.getEnterpriseDirectory().getEnterpriseListArray().size() > 0) {
                navigate = true;
                break;
            }
        }
