...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
    ...
    private void populateNetworkPicker(){
        networkPicker.removeAllItems();
        
        for (Network network : system.getNetworkList()){
            networkPicker.addItem(network);
        }
    }
    
    private void populateEnterprisePicker(Network network){
    ...
    private void initComponents() {
        ...
        networkPicker = new javax.swing.JComboBox();
        ...
        networkPicker.setBackground(new java.awt.Color(79, 173, 177));
        networkPicker.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        networkPicker.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                networkPickerActionPerformed(evt);
            }
        });
        ...
        lblName3.setFont(new java.awt.Font("Devanagari MT", 0, 14)); // NOI18N
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(networkPicker, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(networkPicker, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {enterprisePicker, jLabel3, jLabel4, lblName1, lblName2, lblName3, networkPicker, txtName, txtPassword});
    ...
    private void saveData() {
        ...
        if(enterprise.getEnterpriseType().getValue().equals("Hospital")){
        ...
        } else if(enterprise.getEnterpriseType().getValue().equals("Manufacturing Unit")){
            ...
            UserAccount account = enterprise.getUserAccountDirectory().createUserAccount(username, password, employee, new PharmacyEnterpriseAdminRole());
        }
        populateTable();
        ...
        Toast message = new Toast(mainPanel, "Enterprise admin details added successfully", true);
    ...
    private void networkPickerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_networkPickerActionPerformed

        Network network = (Network) networkPicker.getSelectedItem();
        if (network != null){
            populateEnterprisePicker(network);
        }
    }//GEN-LAST:event_networkPickerActionPerformed
    ...
    private javax.swing.JComboBox networkPicker;
