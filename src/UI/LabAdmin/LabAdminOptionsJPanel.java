...
import UI.LabTechnician.LabTechnicianManageTestResultsJPanel;
 ...
 * @author milindsharma
 */
public class LabAdminOptionsJPanel extends javax.swing.JPanel {
     ...
     */
    public LabAdminOptionsJPanel(EcoSystem system, UserAccount account, Enterprise enterprise) {
        this.system = system;
    ...
    private void initComponents() {
        ...
        btnManageLabTests.setText("Manage Lab Tests");
    ...
    private void btnManageLabTestsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnManageLabTestsActionPerformed
        ...
        LabAdminManageTestsJPanel labAdminManageTestsJPanel = new LabAdminManageTestsJPanel(account, hospital);
        ActivityJPanel.add("LabAdminManageTestsJPanel", labAdminManageTestsJPanel);
