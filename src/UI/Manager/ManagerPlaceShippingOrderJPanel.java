 ...
 * @author rutuja
 */
public class ManagerPlaceShippingOrderJPanel extends javax.swing.JPanel {
    ...
    public ManagerPlaceShippingOrderJPanel(UserAccount userAccount, ArrayList<Enterprise> warehouseEnterpriseArray, Distribution distribution) { 
        initComponents();
    ...
    private void populateWarehousePicker(ArrayList<Warehouse> warehouseArr){
        warehousePicker.removeAllItems();
        int i=0;
        for (Warehouse warehouse: warehouseArr) {
            if (i==0) {
                populateTableProducts(warehouse);
                i++;
            }
      ...
      private void populateTableProducts(Warehouse warehouse){
    ...
    private void initComponents() {
        ...
        jPanel15.setBackground(new java.awt.Color(79, 173, 177));
        jPanel15.setPreferredSize(new java.awt.Dimension(997, 800));
        ...
        tblKits.setBackground(new java.awt.Color(255, 255, 255));
        ...
        lblSelectDistribution.setText("Select Warehouse:");
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jPanel15, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1970, Short.MAX_VALUE))
        );
        mainPanelLayout.setVerticalGroup(
            mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 807, Short.MAX_VALUE)
            .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(jPanel15, javax.swing.GroupLayout.DEFAULT_SIZE, 807, Short.MAX_VALUE))
        );
    ...
    private void btnAddCartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCartActionPerformed
        ...
        int selectedRowIndex = tblKits.getSelectedRow();
