 ...
 * @author milindsharma
 */
public class ManagerOptionsJPanel extends javax.swing.JPanel {

    EcoSystem system;
    Enterprise enterprise;
    UserAccount account;
    
    ArrayList<Enterprise> warehouseEnterpriseArray = new ArrayList<Enterprise>();
    private Distribution distribution;
    /**
     * Creates new form ManagerOptionsJPanel
     */
    public ManagerOptionsJPanel(EcoSystem system, Enterprise enterprise, UserAccount account) {
        this.system = system;
    ...
    private void setModel() {
        ...
        for(Distribution dis:enterprise.getDistributionDirectory().getDistributionsArray()){
        ...
        for(Enterprise ent:net.getEnterpriseDirectory().getEnterpriseListArray()){
            if(ent.getEnterpriseType().getValue().equals("Manufacturing Unit")){
                warehouseEnterpriseArray.add(ent);
            }
        }
    }
    ...
    private void initComponents() {
        ...
        btnViewOrderHistory.setBackground(new java.awt.Color(79, 173, 177));
        ...
        btnPlaceShippingOrder.setBackground(new java.awt.Color(79, 173, 177));
        ...
        btnAssignDeliveryPartner.setBackground(new java.awt.Color(79, 173, 177));
                ...
                .addGroup(OptionsJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(OptionsJPanelLayout.createSequentialGroup()
                        ...
                        .addGroup(OptionsJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(btnPlaceShippingOrder, javax.swing.GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE)))
                    .addGroup(OptionsJPanelLayout.createSequentialGroup()
                        .addGap(75, 75, 75)
                    ...
                    .addGroup(OptionsJPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(btnAssignDeliveryPartner, javax.swing.GroupLayout.DEFAULT_SIZE, 238, Short.MAX_VALUE)))
                .addContainerGap())
        );
