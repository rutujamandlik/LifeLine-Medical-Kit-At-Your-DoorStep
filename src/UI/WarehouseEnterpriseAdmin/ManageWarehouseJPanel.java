...
public class ManageWarehouseJPanel extends javax.swing.JPanel {
     ...
     */
    public ManageWarehouseJPanel(Enterprise enterprise) { 
        initComponents();
        this.enterprise = enterprise;
        populateWarehouseTable();
        btnSubmit.setVisible(false);
        lblWarehouseNameValidation.setVisible(false);
    }
    ...
    private void initComponents() {
        ...
        lblWarehouseNameValidation = new javax.swing.JLabel();
        ...
        jLabel1.setText("Warehouse Details");
        ...
        lblName1.setText("Enter Warehouse Name:");

        txtWarehouseName.setFont(new java.awt.Font("Helvetica", 0, 14)); // NOI18N
        ...
        txtWarehouseName.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                txtWarehouseNameKeyTyped(evt);
            }
        });

        lblWarehouseNameValidation.setFont(new java.awt.Font("Helvetica Neue", 0, 12)); // NOI18N
        lblWarehouseNameValidation.setForeground(new java.awt.Color(255, 0, 51));
        lblWarehouseNameValidation.setText("jLabel2");

        jLabel2.setFont(new java.awt.Font("Devanagari MT", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(0, 0, 0));
        jLabel2.setText("Add Manufacturing Warehouse Name");
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lblWarehouseNameValidation)
                                    .addComponent(txtWarehouseName, javax.swing.GroupLayout.PREFERRED_SIZE, 332, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(txtWarehouseName, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblName1, javax.swing.GroupLayout.PREFERRED_SIZE, 25, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(2, 2, 2)
                .addComponent(lblWarehouseNameValidation, javax.swing.GroupLayout.PREFERRED_SIZE, 14, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnModifyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModifyActionPerformed
        ...
        DefaultTableModel model = (DefaultTableModel) tblWarehouse.getModel();
        Warehouse warehouse = (Warehouse)model.getValueAt(selectedRow, 0);
        
        txtWarehouseName.setText(warehouse.getWareHouseName());
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        Warehouse warehouse = (Warehouse) tblWarehouse.getValueAt(selectedRow, 0);

        this.enterprise.getWarehouseDirectory().deleteWarehouse(warehouse);

        populateWarehouseTable();
        Toast toast = new Toast(mainPanel, "Manufacturing warehouse deleted successfully", true);
    ...
    private void txtWarehouseNameKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtWarehouseNameKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_txtWarehouseNameKeyTyped
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        if (isValidData()) {
            Warehouse warehouse = this.enterprise.createWarehouse(name);

            populateWarehouseTable();
            txtWarehouseName.setText("");
            Toast toast = new Toast(mainPanel, "Manufacturing warehouse added successfully", true);
        }
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        if (isValidData()) {
            ...
            Toast toast = new Toast(mainPanel, "Manufacturing warehouse updated successfully", true);
        }
    ...
    private boolean isValidData() {
        ...
        if (txtWarehouseName.getText().isEmpty()) {
            isValid = false;
            hideShowValidation(lblWarehouseNameValidation, "Please enter warehouse name");
    ...
    private javax.swing.JLabel lblWarehouseNameValidation;
